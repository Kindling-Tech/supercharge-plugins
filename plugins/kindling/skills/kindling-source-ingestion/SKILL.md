...
- The company selected during Kindling browser OAuth is the only tenant
...
The canonical bundled CLI is `../../dist/kindling-guard.cjs`, resolved relative
to the directory containing this `SKILL.md`. Invoke it as
