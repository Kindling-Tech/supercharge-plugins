...
Write this JSON only under gitignored `.kindling/state/staging/`, then pass its
path to `report create --input`.
  ...
  "candidates": [
    {
      ...
      "content": "Exact safe content proposed for Kindling Staging.",
