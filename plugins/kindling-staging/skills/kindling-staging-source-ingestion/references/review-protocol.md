...
The bundled script canonicalizes the exact Kindling Staging tool arguments and computes
...
```text
APPROVE KISR-20260831-101500-ab12 0123456789ab KI-001,KI-003
```
...
Before a Kindling Staging `add_knowledge` call, the hook recomputes the
environment-bound tool-input digest.
